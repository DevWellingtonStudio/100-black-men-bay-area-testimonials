<?php
	...
	/*
	Plugin Name: 100 Black Men Bay Area Testimonials
	Plugin URI:
	Description: Adds testimonial slider to theme through use of [testimonial-slider] shortcode.
	Version: 1.0
	Author: Wellington Studio
	Author URI: https://welliongton-studio.com
	...
	*/
	...
	function tps_super_testimonials_shortcode_register($atts, $content=null) {
		...
		if($themes=="theme1"){
			...
			#testimonial-slider-theme1 .owl-wrapper-outer {
				padding: 1.618rem 0;
			}
			a.testimonial-link {
				color: #000;
			...
			.testimonial-img {
				border-right: 3px solid #2A26F8;
			}
			.owl-item .container .testimonial-theme1 .testimonial-card.card .card-body {
				border: none;
				background-color: transparent;
			}
			.owl-item .container .testimonial-theme1 .testimonial-card.card {
				border: none;
				background-color: transparent;
			}
			...
			while ( $testimonials_query->have_posts() ) : $testimonials_query->the_post();
				...
				<div class="container-fluid">
					<div class="container">
						<div class="d-flex justify-content-center align-items-center row testimonial-'.$themes.'">
							<div class="testimonial-img col-md-3">
								<img class="mx-auto d-block" src="'.$imgurl.'" alt="">
							</div>
							<div class="col-md-9">
								<div class="testimonial-card card">
									<div class="card-body">';
										...
										<div class="testimonial-description-profiles-'.$themes.'">
											<span class="testimonial-name testimonial-description-title-'.$themes.'"><strong>'.esc_attr($client_name_value).'</strong></span><br><small><a class="testimonial-link" target="'.$company_url_target.'" href="'.esc_url($company_url).'">'.$link_value.'</a></small>
										</div>
									</div>
								</div>
							</div>
		...
		elseif($themes=="theme4"){
			...
			while ( $testimonials_query->have_posts() ) : $testimonials_query->the_post();
				...
				$result .='
					<div class="container">
					<div class="row testimonial-theme4-'.$themes.'">
						<div class=" col-md-4 testimonial-theme4-pic-'.$themes.'">
						<img src="'.$imgurl.'" alt="">
						</div>
						<div class="col-md-8">
	...
	add_shortcode('testimonial-slider', 'tps_super_testimonials_shortcode_register');
